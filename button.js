...
const Button = function (props) {
  ...
  var el = props.href && yo`<a href="${props.href}" target="${target}" class="${elClass}">${Children(arguments)}</a>` || yo`<button type=${elType} onclick=${onClick} class="${elClass}">${Children(arguments)}</button>`
